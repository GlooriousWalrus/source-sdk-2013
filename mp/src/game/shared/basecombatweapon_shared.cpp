...
//-----------------------------------------------------------------------------
// Purpose:  Changing FOV from a script file
//-----------------------------------------------------------------------------
...
BEGIN_NETWORK_TABLE(CBaseCombatWeapon, DT_BaseCombatWeapon)
    ...
    SendPropBool( SENDINFO( m_bIsIronsighted ) ),//IRONSIGHTS
	...
	RecvPropFloat( RECVINFO( m_flIronsightedTime ) ),//IRONSIGHTS
#endif
END_NETWORK_TABLE()
