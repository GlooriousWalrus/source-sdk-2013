...
ConVar	cl_phys_props_max( "cl_phys_props_max", "500", 0, "Maximum clientside physic props" ); //300
ConVar	r_propsmaxdist( "r_propsmaxdist", "3000", 0, "Maximum visible distance" ); //1200
